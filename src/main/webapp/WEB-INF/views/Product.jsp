...
// 								var context = "";
								var time = 0;
								//Uncaught TypeError: cartItem.content is not iterable at 
								//XMLHttpRequest.xhr2.onreadystatechange (getAllProductInfo:667)
					            for (let [key,value] of cartItem.content) { 
					            	time++;
